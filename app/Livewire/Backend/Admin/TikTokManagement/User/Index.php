...
class Index extends Component
{
    ...
    public function boot(TikTokUserService $service)
    {
    ...
    public function render()
    {
        ...
        $actions = [
            [
                'key' => 'id',
                'label' => 'Show',
                'route' => 'admin.tm.user.view',
                'encrypt' => true
            ],
            [
                'key' => 'id',
                'label' => 'Edit',
                'route' => 'admin.tm.user.edit',
                'encrypt' => true
            ],
            [
                'key' => 'id',
        ...
        return view('livewire.backend.admin.tik-tok-management.user.index', [
            'datas' => $datas,
    ...
    {
        try {
            $dataStatus = TikTokUserStatus::from($status);

            match ($dataStatus) {
                TikTokUserStatus::ACTIVE => $this->service->updateStatusData($id, TikTokUserStatus::ACTIVE),
                TikTokUserStatus::INACTIVE => $this->service->updateStatusData($id, TikTokUserStatus::INACTIVE),
                default => null,
            };
    ...
    public function executeBulkAction(): void
    {
        ...
        try {
            match ($this->bulkAction) {
                ...
                'active' => $this->bulkUpdateStatus(TikTokUserStatus::ACTIVE),
                'inactive' => $this->bulkUpdateStatus(TikTokUserStatus::INACTIVE),
                default => null,
            };
    ...
    protected function bulkUpdateStatus(TikTokUserStatus $status): void
    {
