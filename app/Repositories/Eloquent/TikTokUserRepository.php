...
class TikTokUserRepository implements TikTokUserRepositoryInterface
{
    /**
     * Create a new class instance.
     */
    public function __construct(
        protected TikTokUser $model
    ) {
    }
    ...
    public function find($column_value, string $column_name = 'id', bool $trashed = false): ?TikTokUser
    {
        $model = $this->model;
        if ($trashed) {
    ...
    public function findTrashed($column_value, string $column_name = 'id'): ?TikTokUser
    {
    ...
    public function paginate(int $perPage = 15, array $filters = []): LengthAwarePaginator
    {
        ...
        if ($search) {
            // Scout Search
            return TikTokUser::search($search)
    ...
    public function create(array $data): TikTokUser
    {
