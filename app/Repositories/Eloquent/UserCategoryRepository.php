...
class UserCategoryRepository implements UserCategoryRepositoryInterface
{
    ...
    * ================== ================== ================== */
    ...
    public function find($column_value, string $column_name = 'id',  bool $trashed = false): ?UserCategory
    {
        $model = $this->model;
        if ($trashed) {
    ...
    public function findTrashed($column_value, string $column_name = 'id'): ?UserCategory
    {
    ...
    public function paginate(int $perPage = 15, array $filters = []): LengthAwarePaginator
    {
        ...
        if ($search) {
            // Scout Search
            return UserCategory::search($search)
