...
class VideoRepository implements VideoRepositoryInterface
{
    ...
    * ================== ================== ================== */
    ...
    public function find($column_value, string $column_name = 'id', bool $trashed = false): ?Video
    {
        $model = $this->model;
        if ($trashed) {
    ...
    public function findTrashed($column_value, string $column_name = 'id'): ?Video
    {
