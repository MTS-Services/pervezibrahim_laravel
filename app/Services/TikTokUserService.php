...
use App\Actions\TikTokUser\BulkAction;
use App\Actions\TikTokUser\CreateAction;
use App\Actions\TikTokUser\DeleteAction;
use App\Actions\TikTokUser\UpdateAction;
use App\Actions\TikTokUser\RestoreAction;
...
class TikTokUserService
{
    ...
    * ================== ================== ================== */
    ...
    public function findData($column_value, string $column_name = 'id'): ?TikTokUser
    {
    ...
    * ================== ================== ================== */
    ...
    public function createData(array $data): TikTokUser
    {
        return $this->createAction->execute($data);
    }

    public function updateData(int $id, array $data): TikTokUser
    {
    ...
    public function updateStatusData(int $id, TikTokUserStatus $status, ?int $actionerId = null): TikTokUser
    {
        if ($actionerId == null) {
            $actionerId = admin()->id;
        }
    ...
    public function bulkUpdateStatus(array $ids, TikTokUserStatus $status, ?int $actionerId = null): int
    {
        if ($actionerId == null) {
            $actionerId = admin()->id;
        }
