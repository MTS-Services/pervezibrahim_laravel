<div class="bg-zinc-950">
    <section class="container pt-28 pb-12">
        <div class="flex justify-center items-center relative">
            <span class="bg-second-600 p-2 rounded-full absolute top-50 -left-10 translate-y-50">
            ...
            <span class="bg-second-600 p-2 rounded-full absolute top-50 -right-10 translate-y-50">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 stroke-white" viewBox="0 0 24 24" fill="none"
                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="flex justify-center mt-4">
            <div
                ...
                <button class="hover:text-white transition py-4 stroke-white/80 pr-4"><svg class="w-5 h-5" fill="none"
                         viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
