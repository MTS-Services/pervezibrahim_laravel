    ...
    <section class="max-w-6xl mx-auto pt-28 pb-12">
        ...
        <div class="flex justify-center mt-4 scroll-animate-y-reverse">
            <div
                ...
                <button class="py-4 stroke-white/60"><svg class="w-5 h-5 hover:stroke-white transition-all duration-300 ease-in-out" fill="none"
                        viewBox="0 0 24 24">
                ...
                <button class="py-4 stroke-white/60 pr-4"><svg class="w-5 h-5 hover:stroke-white transition-all duration-300 ease-in-out"
