            ...
            <div class="md:col-span-12 lg:col-span-6">
                ...
                <div class="space-y-3 mb-8 md:mb-0">
                    <a href="mailto:support@ebsixone.com"
                        class="flex items-center gap-2 text-gray-700 hover:text-second-500  hover:underline transition-colors text-sm sm:text-base group hover:underline">
                        <svg class="w-5 h-5 flex-shrink-0 stroke-black group-hover:stroke-second-500" fill="none" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207">
                            </path>
                        </svg>
                        <span class="break-all group-hover:text-second-500">support@ebsixone.com</span>
                    </a>
                    ...
                    <a href="mailto:careers@ebsixone.com"
                        ...
                        <span class="break-all group-hover:text-second-500">careers@ebsixone.com</span>
                    </a>
                    ...
                    <a href="mailto:press@ebsixone.com"
                        ...
                        <span class="break-all group-hover:text-second-500">press@ebsixone.com</span>
                    </a>
                </div>
            </div>
                    ...
                    <ul class="space-y-2 sm:space-y-2.5">
                        <li>
                            <a href="{{ route('services') }}" wire:navigate
                                class="text-zinc-700 hover:text-second-500  hover:underline transition-colors text-sm sm:text-base">
                                {{ __('Services') }}
                            </a>
                        </li>
                        <li>
