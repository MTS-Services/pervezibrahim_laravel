                ...
                <div
                    ...
                    <div id="controls"
                        ...
                        <div class="w-full h-1.5 bg-white/20 rounded-full mb-4 cursor-pointer overflow-hidden relative"
                            ...
                            <div id="progressBar"
                                class="absolute top-0 left-0 h-full bg-red-600 w-0 transition-all duration-100"></div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-6">
                                <button id="playBtn"
                                    class="text-white hover:text-blue-400 hover:scale-110 transition-all">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex items-center gap-2 group/vol">
                                        ...
                                        <div
                                            ...
                                            <input type="range" class="w-full accent-red-600" min="0"
                            ...
                            <div class="flex items-center gap-6">
                                ...
                                <button class="p-1 text-white hover:text-blue-400 transition-colors">
                                ...
                                <button id="fullscreenBtn" class=" hover:text-blue-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="#ffffff" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
